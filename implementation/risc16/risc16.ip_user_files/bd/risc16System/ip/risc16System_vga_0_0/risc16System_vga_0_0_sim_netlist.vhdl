...
architecture STRUCTURE of risc16System_vga_0_0_vga is
  ...
  attribute SOFT_HLUTNM of \blue[3]_INST_0_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \blue[3]_INST_0_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \blue[3]_INST_0_i_4\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \vcount[6]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \vcount[9]_i_3\ : label is "soft_lutpair8";
...
\blue[0]_INST_0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00008AA000008AAA"
        ...
        port map (
      I0 => \hcount_reg__0\(0),
      I1 => \blue[3]_INST_0_i_1_n_0\,
      I2 => \hcount_reg__0\(8),
      I3 => \hcount_reg__0\(9),
      I4 => \blue[3]_INST_0_i_2_n_0\,
      I5 => \blue[3]_INST_0_i_3_n_0\,
      O => red(0)
    );
...
\blue[3]_INST_0_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0010FFFF"
    )
        port map (
      I0 => \hcount_reg__0\(5),
      I1 => \hcount_reg__0\(6),
      I2 => \blue[3]_INST_0_i_4_n_0\,
      I3 => \hcount_reg__0\(4),
      I4 => \hcount_reg__0\(7),
      O => \blue[3]_INST_0_i_3_n_0\
    );
\blue[3]_INST_0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
begin
  blue(3 downto 0) <= \^red\(3 downto 0);
