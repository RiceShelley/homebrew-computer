...
HD_PWD='/home/rootie/devel/homebrew-computer/implementation/risc16/risc16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log risc16System_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source risc16System_wrapper.tcl
