...
HD_PWD='/home/rootie/devel/homebrew-computer/implementation/risc16/risc16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log risc16System_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source risc16System_wrapper.tcl -notrace
