...
HD_PWD='/home/rootie/risc16/risc16.runs/risc16System_display_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log risc16System_display_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source risc16System_display_ctrl_0_0.tcl
